...
import { getMemberAllTeam } from "@src/actions/teamActions";
...
const MemberDownlineList = ({
  ...
  useEffect(() => {
    if (userId) {
      getMemberAllTeam(userId, params);
    }
  ...
  return (
    <Container>
      <AppBreadCrumb
        pageTitle={`${memberLabel} - Downline List`}
        crumbs={[
      ...
      <MainCard>
        <div className="mb-3">
          <h5 className="mb-1">Total Downline</h5>
          <p className="text-muted small mb-0">
            Complete downline of this member (all levels).
          </p>
        </div>
...
export default connect(mapStateToProps, { getMemberAllTeam })(MemberDownlineList);
